...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__97465_SHARP_){
return ((p1__97465_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__97465_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__97476,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__97476;
}
});
...
var len__36461__auto___97501 = arguments.length;
var i__36462__auto___97502 = (0);
while(true){
if((i__36462__auto___97502 < len__36461__auto___97501)){
args__36468__auto__.push((arguments[i__36462__auto___97502]));

var G__97504 = (i__36462__auto___97502 + (1));
i__36462__auto___97502 = G__97504;
continue;
} else {
}
break;
...
var G__97491 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__97491,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__97491;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq97490){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq97490));
});
/**
...
var vec__97532 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__97532,(0),null);
var names = cljs.core.nth.call(null,vec__97532,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__97532,tag_name,names){
return (function (p1__97509_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__97509_SHARP_));
});})(matches,vec__97532,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__97532,tag_name,names){
return (function (p1__97510_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__97510_SHARP_));
});})(matches,vec__97532,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__97573){
var vec__97576 = p__97573;
var tag = cljs.core.nth.call(null,vec__97576,(0),null);
var content = cljs.core.nthnext.call(null,vec__97576,(1));
...
var vec__97587 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__97587,(0),null);
var id = cljs.core.nth.call(null,vec__97587,(1),null);
var class$ = cljs.core.nth.call(null,vec__97587,(2),null);
