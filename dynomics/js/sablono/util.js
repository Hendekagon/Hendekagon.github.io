...
var m__36056__auto__ = (sablono.util.to_str[goog.typeOf(x__36055__auto__)]);
if(!((m__36056__auto__ == null))){
return m__36056__auto__.call(null,x);
} else {
var m__36056__auto____$1 = (sablono.util.to_str["_"]);
...
var x__36055__auto__ = (((x == null))?null:x);
var m__36056__auto__ = (sablono.util.to_uri[goog.typeOf(x__36055__auto__)]);
if(!((m__36056__auto__ == null))){
return m__36056__auto__.call(null,x);
} else {
var m__36056__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__36056__auto____$1 == null))){
return m__36056__auto____$1.call(null,x);
} else {
...
var len__36461__auto___284082 = arguments.length;
var i__36462__auto___284083 = (0);
while(true){
if((i__36462__auto___284083 < len__36461__auto___284082)){
args__36468__auto__.push((arguments[i__36462__auto___284083]));

var G__284084 = (i__36462__auto___284083 + (1));
i__36462__auto___284083 = G__284084;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__36469__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq284067){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq284067));
});
/**
...
var vec__284107 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__284107,(0),null);
var words = cljs.core.nthnext.call(null,vec__284107,(1));
...
var G__284114 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__284114,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__284114;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__284115_SHARP_){
if(typeof p1__284115_SHARP_ === 'string'){
return p1__284115_SHARP_;
} else {
return cljs.core.seq.call(null,p1__284115_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__35392__auto__ = x__$1.hasDomain();
