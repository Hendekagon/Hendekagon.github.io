 ...
 */
dommy.utils.dissoc_in = (function dommy$utils$dissoc_in(m,p__131296){
var vec__131298 = p__131296;
var k = cljs.core.nth.call(null,vec__131298,(0),null);
var ks = cljs.core.nthnext.call(null,vec__131298,(1));
if(cljs.core.truth_(m)){
var temp__4655__auto__ = (function (){var and__35413__auto__ = ks;
...
return [cljs.core.str((function (){var G__131308 = cljs.core.namespace.call(null,s);
if((G__131308 == null)){
return null;
} else {
return [cljs.core.str(G__131308),cljs.core.str("/")].join('');
}
...
var and__35413__auto__ = ((idx === (0))) || ((" " === class_name.charAt((idx - (1)))));
...
var G__131417 = (i + class$.length);
start_from = G__131417;
continue;
}
} else {
return null;
...
var G__131427 = (function (){var end = (i + class$.length);
return [cljs.core.str((((end < class_len))?[cljs.core.str(class_name.substring((0),i)),cljs.core.str(class_name.substr((end + (1))))].join(''):class_name.substring((0),(i - (1)))))].join('');
})();
class_name = G__131427;
continue;
} else {
return class_name;
}
