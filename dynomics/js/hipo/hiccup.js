...
if((i__$1 > (0))){
var G__125105 = s__$1.replace(hipo.hiccup.class_separator," ");
s__$1 = G__125105;
continue;
} else {
return s__$1;
...
if(cljs.core.truth_((function (){var and__35413__auto__ = id;
...
if(cljs.core.truth_((function (){var or__35425__auto__ = id;
...
if(cljs.core.truth_((function (){var or__35425__auto__ = (o == null);
if(or__35425__auto__){
return or__35425__auto__;
} else {
var or__35425__auto____$1 = hipo.hiccup.literal_QMARK_.call(null,o);
...
var G__125114 = ((cljs.core.seq_QMARK_.call(null,f))?hipo.fast.conjs_BANG_.call(null,acc,f):cljs.core.conj_BANG_.call(null,acc,f));
var G__125115 = cljs.core.subvec.call(null,v__$1,(1));
acc = G__125114;
v__$1 = G__125115;
continue;
}
