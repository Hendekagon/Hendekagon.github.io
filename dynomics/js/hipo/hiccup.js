...
if((i__$1 > (0))){
var G__1881140 = s__$1.replace(hipo.hiccup.class_separator," ");
s__$1 = G__1881140;
continue;
} else {
return s__$1;
...
if(cljs.core.truth_((function (){var and__24149__auto__ = id;
...
if(cljs.core.truth_((function (){var or__24161__auto__ = id;
...
if(cljs.core.truth_((function (){var or__24161__auto__ = (o == null);
if(or__24161__auto__){
return or__24161__auto__;
} else {
var or__24161__auto____$1 = hipo.hiccup.literal_QMARK_.call(null,o);
...
var G__1881142 = ((cljs.core.seq_QMARK_.call(null,f))?hipo.fast.conjs_BANG_.call(null,acc,f):cljs.core.conj_BANG_.call(null,acc,f));
var G__1881143 = cljs.core.subvec.call(null,v__$1,(1));
acc = G__1881142;
v__$1 = G__1881143;
continue;
}
