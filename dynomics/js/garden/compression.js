 ...
 */
garden.compression.token_fn = (function garden$compression$token_fn(p__284360){
var vec__284366 = p__284360;
var tag = cljs.core.nth.call(null,vec__284366,(0),null);
var re = cljs.core.nth.call(null,vec__284366,(1),null);
return ((function (vec__284366,tag,re){
return (function (s){
...
var len__36461__auto___284386 = arguments.length;
var i__36462__auto___284387 = (0);
while(true){
if((i__36462__auto___284387 < len__36461__auto___284386)){
args__36468__auto__.push((arguments[i__36462__auto___284387]));

var G__284389 = (i__36462__auto___284387 + (1));
i__36462__auto___284387 = G__284389;
continue;
} else {
}
break;
...
return garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(argseq__36469__auto__);
});
...
return (function (p1__284368_SHARP_){
return p1__284368_SHARP_.call(null,s);
});})(fs))
,fs);
});
;})(fs))
...
garden.compression.tokenizer.cljs$lang$applyTo = (function (seq284369){
return garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq284369));
});
/**
...
var map__284398 = temp__4655__auto__;
var map__284398__$1 = ((((!((map__284398 == null)))?((((map__284398.cljs$lang$protocol_mask$partition0$ & (64))) || (map__284398.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__284398):map__284398);
var tag = cljs.core.get.call(null,map__284398__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.call(null,map__284398__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.call(null,map__284398__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__284413 = cljs.core.subs.call(null,s1,size);
var G__284415 = [cljs.core.str(s2),cljs.core.str((function (){var G__284400 = (((tag instanceof cljs.core.Keyword))?tag.fqn:null);
switch (G__284400) {
case "l-brace":
return "}";
