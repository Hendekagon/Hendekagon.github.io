 ...
 */
garden.compression.token_fn = (function garden$compression$token_fn(p__449502){
var vec__449507 = p__449502;
var tag = cljs.core.nth.call(null,vec__449507,(0),null);
var re = cljs.core.nth.call(null,vec__449507,(1),null);
return ((function (vec__449507,tag,re){
return (function (s){
...
var len__36260__auto___449516 = arguments.length;
var i__36261__auto___449517 = (0);
while(true){
if((i__36261__auto___449517 < len__36260__auto___449516)){
args__36267__auto__.push((arguments[i__36261__auto___449517]));

var G__449520 = (i__36261__auto___449517 + (1));
i__36261__auto___449517 = G__449520;
continue;
} else {
}
break;
...
return (function (p1__449512_SHARP_){
return p1__449512_SHARP_.call(null,s);
});})(fs))
,fs);
});
;})(fs))
...
garden.compression.tokenizer.cljs$lang$applyTo = (function (seq449513){
return garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq449513));
});
/**
...
var map__449539 = temp__4655__auto__;
var map__449539__$1 = ((((!((map__449539 == null)))?((((map__449539.cljs$lang$protocol_mask$partition0$ & (64))) || (map__449539.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__449539):map__449539);
var tag = cljs.core.get.call(null,map__449539__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.call(null,map__449539__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.call(null,map__449539__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__449550 = cljs.core.subs.call(null,s1,size);
var G__449551 = [cljs.core.str(s2),cljs.core.str((function (){var G__449543 = (((tag instanceof cljs.core.Keyword))?tag.fqn:null);
switch (G__449543) {
case "l-brace":
return "}";
