...
garden.types.CSSUnit.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__35815__auto__,k282048,else__35816__auto__){
var self__ = this;
var this__35815__auto____$1 = this;
var G__282050 = (((k282048 instanceof cljs.core.Keyword))?k282048.fqn:null);
switch (G__282050) {
case "unit":
return self__.unit;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k282048,else__35816__auto__);
...
garden.types.CSSUnit.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__282047){
var self__ = this;
var G__282047__$1 = this;
return (new cljs.core.RecordIter((0),G__282047__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"unit","unit",375175175),new cljs.core.Keyword(null,"magnitude","magnitude",1924274222)], null),cljs.core._iterator.call(null,self__.__extmap)));
});
...
garden.types.CSSUnit.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__35820__auto__,k__35821__auto__,G__282047){
var self__ = this;
var this__35820__auto____$1 = this;
var pred__282058 = cljs.core.keyword_identical_QMARK_;
var expr__282059 = k__35821__auto__;
if(cljs.core.truth_(pred__282058.call(null,new cljs.core.Keyword(null,"unit","unit",375175175),expr__282059))){
return (new garden.types.CSSUnit(G__282047,self__.magnitude,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__282058.call(null,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222),expr__282059))){
return (new garden.types.CSSUnit(self__.unit,G__282047,self__.__meta,self__.__extmap,null));
} else {
return (new garden.types.CSSUnit(self__.unit,self__.magnitude,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__35821__auto__,G__282047),null));
}
}
});
...
garden.types.CSSUnit.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__35812__auto__,G__282047){
var self__ = this;
var this__35812__auto____$1 = this;
return (new garden.types.CSSUnit(self__.unit,self__.magnitude,G__282047,self__.__extmap,self__.__hash));
});
...
garden.types.map__GT_CSSUnit = (function garden$types$map__GT_CSSUnit(G__282049){
return (new garden.types.CSSUnit(new cljs.core.Keyword(null,"unit","unit",375175175).cljs$core$IFn$_invoke$arity$1(G__282049),new cljs.core.Keyword(null,"magnitude","magnitude",1924274222).cljs$core$IFn$_invoke$arity$1(G__282049),null,cljs.core.dissoc.call(null,G__282049,new cljs.core.Keyword(null,"unit","unit",375175175),new cljs.core.Keyword(null,"magnitude","magnitude",1924274222)),null));
});
...
garden.types.CSSFunction.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__35815__auto__,k282077,else__35816__auto__){
var self__ = this;
var this__35815__auto____$1 = this;
var G__282081 = (((k282077 instanceof cljs.core.Keyword))?k282077.fqn:null);
switch (G__282081) {
case "function":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k282077,else__35816__auto__);
...
garden.types.CSSFunction.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__282076){
var self__ = this;
var G__282076__$1 = this;
return (new cljs.core.RecordIter((0),G__282076__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"function","function",-2127255473),new cljs.core.Keyword(null,"args","args",1315556576)], null),cljs.core._iterator.call(null,self__.__extmap)));
});
...
garden.types.CSSFunction.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__35820__auto__,k__35821__auto__,G__282076){
var self__ = this;
var this__35820__auto____$1 = this;
var pred__282084 = cljs.core.keyword_identical_QMARK_;
var expr__282085 = k__35821__auto__;
if(cljs.core.truth_(pred__282084.call(null,new cljs.core.Keyword(null,"function","function",-2127255473),expr__282085))){
return (new garden.types.CSSFunction(G__282076,self__.args,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__282084.call(null,new cljs.core.Keyword(null,"args","args",1315556576),expr__282085))){
return (new garden.types.CSSFunction(self__.function$,G__282076,self__.__meta,self__.__extmap,null));
} else {
return (new garden.types.CSSFunction(self__.function$,self__.args,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__35821__auto__,G__282076),null));
}
}
});
...
garden.types.CSSFunction.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__35812__auto__,G__282076){
var self__ = this;
var this__35812__auto____$1 = this;
return (new garden.types.CSSFunction(self__.function$,self__.args,G__282076,self__.__extmap,self__.__hash));
});
...
garden.types.map__GT_CSSFunction = (function garden$types$map__GT_CSSFunction(G__282078){
return (new garden.types.CSSFunction(new cljs.core.Keyword(null,"function","function",-2127255473).cljs$core$IFn$_invoke$arity$1(G__282078),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(G__282078),null,cljs.core.dissoc.call(null,G__282078,new cljs.core.Keyword(null,"function","function",-2127255473),new cljs.core.Keyword(null,"args","args",1315556576)),null));
});
...
garden.types.CSSAtRule.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__35815__auto__,k282101,else__35816__auto__){
var self__ = this;
var this__35815__auto____$1 = this;
var G__282106 = (((k282101 instanceof cljs.core.Keyword))?k282101.fqn:null);
switch (G__282106) {
case "identifier":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k282101,else__35816__auto__);
...
garden.types.CSSAtRule.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__282100){
var self__ = this;
var G__282100__$1 = this;
return (new cljs.core.RecordIter((0),G__282100__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"identifier","identifier",-805503498),new cljs.core.Keyword(null,"value","value",305978217)], null),cljs.core._iterator.call(null,self__.__extmap)));
});
...
garden.types.CSSAtRule.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__35820__auto__,k__35821__auto__,G__282100){
var self__ = this;
var this__35820__auto____$1 = this;
var pred__282107 = cljs.core.keyword_identical_QMARK_;
var expr__282108 = k__35821__auto__;
if(cljs.core.truth_(pred__282107.call(null,new cljs.core.Keyword(null,"identifier","identifier",-805503498),expr__282108))){
return (new garden.types.CSSAtRule(G__282100,self__.value,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__282107.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__282108))){
return (new garden.types.CSSAtRule(self__.identifier,G__282100,self__.__meta,self__.__extmap,null));
} else {
return (new garden.types.CSSAtRule(self__.identifier,self__.value,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__35821__auto__,G__282100),null));
}
}
});
...
garden.types.CSSAtRule.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__35812__auto__,G__282100){
var self__ = this;
var this__35812__auto____$1 = this;
return (new garden.types.CSSAtRule(self__.identifier,self__.value,G__282100,self__.__extmap,self__.__hash));
});
...
garden.types.map__GT_CSSAtRule = (function garden$types$map__GT_CSSAtRule(G__282102){
return (new garden.types.CSSAtRule(new cljs.core.Keyword(null,"identifier","identifier",-805503498).cljs$core$IFn$_invoke$arity$1(G__282102),new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__282102),null,cljs.core.dissoc.call(null,G__282102,new cljs.core.Keyword(null,"identifier","identifier",-805503498),new cljs.core.Keyword(null,"value","value",305978217)),null));
});
