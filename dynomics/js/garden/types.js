...
garden.types.CSSUnit.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__36046__auto__,k65509,else__36047__auto__){
var self__ = this;
var this__36046__auto____$1 = this;
var G__65511 = (((k65509 instanceof cljs.core.Keyword))?k65509.fqn:null);
switch (G__65511) {
case "unit":
return self__.unit;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k65509,else__36047__auto__);
...
garden.types.CSSUnit.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__65508){
var self__ = this;
var G__65508__$1 = this;
return (new cljs.core.RecordIter((0),G__65508__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"unit","unit",375175175),new cljs.core.Keyword(null,"magnitude","magnitude",1924274222)], null),cljs.core._iterator.call(null,self__.__extmap)));
});
...
garden.types.CSSUnit.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__36051__auto__,k__36052__auto__,G__65508){
var self__ = this;
var this__36051__auto____$1 = this;
var pred__65512 = cljs.core.keyword_identical_QMARK_;
var expr__65513 = k__36052__auto__;
if(cljs.core.truth_(pred__65512.call(null,new cljs.core.Keyword(null,"unit","unit",375175175),expr__65513))){
return (new garden.types.CSSUnit(G__65508,self__.magnitude,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__65512.call(null,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222),expr__65513))){
return (new garden.types.CSSUnit(self__.unit,G__65508,self__.__meta,self__.__extmap,null));
} else {
return (new garden.types.CSSUnit(self__.unit,self__.magnitude,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__36052__auto__,G__65508),null));
}
}
});
...
garden.types.CSSUnit.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__36043__auto__,G__65508){
var self__ = this;
var this__36043__auto____$1 = this;
return (new garden.types.CSSUnit(self__.unit,self__.magnitude,G__65508,self__.__extmap,self__.__hash));
});
...
garden.types.map__GT_CSSUnit = (function garden$types$map__GT_CSSUnit(G__65510){
return (new garden.types.CSSUnit(new cljs.core.Keyword(null,"unit","unit",375175175).cljs$core$IFn$_invoke$arity$1(G__65510),new cljs.core.Keyword(null,"magnitude","magnitude",1924274222).cljs$core$IFn$_invoke$arity$1(G__65510),null,cljs.core.dissoc.call(null,G__65510,new cljs.core.Keyword(null,"unit","unit",375175175),new cljs.core.Keyword(null,"magnitude","magnitude",1924274222)),null));
});
...
garden.types.CSSFunction.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__36046__auto__,k65517,else__36047__auto__){
var self__ = this;
var this__36046__auto____$1 = this;
var G__65519 = (((k65517 instanceof cljs.core.Keyword))?k65517.fqn:null);
switch (G__65519) {
case "function":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k65517,else__36047__auto__);
...
garden.types.CSSFunction.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__65516){
var self__ = this;
var G__65516__$1 = this;
return (new cljs.core.RecordIter((0),G__65516__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"function","function",-2127255473),new cljs.core.Keyword(null,"args","args",1315556576)], null),cljs.core._iterator.call(null,self__.__extmap)));
});
...
garden.types.CSSFunction.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__36051__auto__,k__36052__auto__,G__65516){
var self__ = this;
var this__36051__auto____$1 = this;
var pred__65520 = cljs.core.keyword_identical_QMARK_;
var expr__65521 = k__36052__auto__;
if(cljs.core.truth_(pred__65520.call(null,new cljs.core.Keyword(null,"function","function",-2127255473),expr__65521))){
return (new garden.types.CSSFunction(G__65516,self__.args,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__65520.call(null,new cljs.core.Keyword(null,"args","args",1315556576),expr__65521))){
return (new garden.types.CSSFunction(self__.function$,G__65516,self__.__meta,self__.__extmap,null));
} else {
return (new garden.types.CSSFunction(self__.function$,self__.args,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__36052__auto__,G__65516),null));
}
}
});
...
garden.types.CSSFunction.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__36043__auto__,G__65516){
var self__ = this;
var this__36043__auto____$1 = this;
return (new garden.types.CSSFunction(self__.function$,self__.args,G__65516,self__.__extmap,self__.__hash));
});
...
garden.types.map__GT_CSSFunction = (function garden$types$map__GT_CSSFunction(G__65518){
return (new garden.types.CSSFunction(new cljs.core.Keyword(null,"function","function",-2127255473).cljs$core$IFn$_invoke$arity$1(G__65518),new cljs.core.Keyword(null,"args","args",1315556576).cljs$core$IFn$_invoke$arity$1(G__65518),null,cljs.core.dissoc.call(null,G__65518,new cljs.core.Keyword(null,"function","function",-2127255473),new cljs.core.Keyword(null,"args","args",1315556576)),null));
});
...
garden.types.CSSAtRule.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__36046__auto__,k65525,else__36047__auto__){
var self__ = this;
var this__36046__auto____$1 = this;
var G__65527 = (((k65525 instanceof cljs.core.Keyword))?k65525.fqn:null);
switch (G__65527) {
case "identifier":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k65525,else__36047__auto__);
...
garden.types.CSSAtRule.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__65524){
var self__ = this;
var G__65524__$1 = this;
return (new cljs.core.RecordIter((0),G__65524__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"identifier","identifier",-805503498),new cljs.core.Keyword(null,"value","value",305978217)], null),cljs.core._iterator.call(null,self__.__extmap)));
});
...
garden.types.CSSAtRule.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__36051__auto__,k__36052__auto__,G__65524){
var self__ = this;
var this__36051__auto____$1 = this;
var pred__65528 = cljs.core.keyword_identical_QMARK_;
var expr__65529 = k__36052__auto__;
if(cljs.core.truth_(pred__65528.call(null,new cljs.core.Keyword(null,"identifier","identifier",-805503498),expr__65529))){
return (new garden.types.CSSAtRule(G__65524,self__.value,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__65528.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__65529))){
return (new garden.types.CSSAtRule(self__.identifier,G__65524,self__.__meta,self__.__extmap,null));
} else {
return (new garden.types.CSSAtRule(self__.identifier,self__.value,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__36052__auto__,G__65524),null));
}
}
});
...
garden.types.CSSAtRule.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__36043__auto__,G__65524){
var self__ = this;
var this__36043__auto____$1 = this;
return (new garden.types.CSSAtRule(self__.identifier,self__.value,G__65524,self__.__extmap,self__.__hash));
});
...
garden.types.map__GT_CSSAtRule = (function garden$types$map__GT_CSSAtRule(G__65526){
return (new garden.types.CSSAtRule(new cljs.core.Keyword(null,"identifier","identifier",-805503498).cljs$core$IFn$_invoke$arity$1(G__65526),new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__65526),null,cljs.core.dissoc.call(null,G__65526,new cljs.core.Keyword(null,"identifier","identifier",-805503498),new cljs.core.Keyword(null,"value","value",305978217)),null));
});


//# sourceMappingURL=types.js.map?rel=1459533425901