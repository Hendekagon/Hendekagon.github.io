...
dynomics.ui.core.keydown = (function dynomics$ui$core$keydown(p__132966){
var map__132969 = p__132966;
var map__132969__$1 = ((((!((map__132969 == null)))?((((map__132969.cljs$lang$protocol_mask$partition0$ & (64))) || (map__132969.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__132969):map__132969);
var state = map__132969__$1;
var event = cljs.core.get.call(null,map__132969__$1,new cljs.core.Keyword(null,"event","event",301435442));
return cljs.core.assoc.call(null,cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"keypath","keypath",1965534711)], null),((function (map__132969,map__132969__$1,state,event){
return (function (kp){
return cljs.core.conj.call(null,kp,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event));
});})(map__132969,map__132969__$1,state,event))
...
var args132971 = [];
var len__36494__auto___132977 = arguments.length;
var i__36495__auto___132978 = (0);
while(true){
if((i__36495__auto___132978 < len__36494__auto___132977)){
args132971.push((arguments[i__36495__auto___132978]));

var G__132979 = (i__36495__auto___132978 + (1));
i__36495__auto___132978 = G__132979;
continue;
} else {
}
break;
...
var G__132973 = args132971.length;
switch (G__132973) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args132971.length)].join('')));

}
});

dynomics.ui.core.keyup.cljs$core$IFn$_invoke$arity$1 = (function (p__132974){
var map__132975 = p__132974;
var map__132975__$1 = ((((!((map__132975 == null)))?((((map__132975.cljs$lang$protocol_mask$partition0$ & (64))) || (map__132975.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__132975):map__132975);
var state = map__132975__$1;
var event = cljs.core.get.call(null,map__132975__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var or__35425__auto__ = f.call(null,dynomics.ui.core.kop.call(null,cljs.core.assoc.call(null,s,new cljs.core.Keyword(null,"fn","fn",-1175266204),f.name)));
...
var args132982 = [];
var len__36494__auto___132985 = arguments.length;
var i__36495__auto___132986 = (0);
while(true){
if((i__36495__auto___132986 < len__36494__auto___132985)){
args132982.push((arguments[i__36495__auto___132986]));

var G__132987 = (i__36495__auto___132986 + (1));
i__36495__auto___132986 = G__132987;
continue;
} else {
}
break;
...
var G__132984 = args132982.length;
switch (G__132984) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args132982.length)].join('')));
...
return cljs.core.conj.call(null,(function (){var or__35425__auto__ = h;
if(cljs.core.truth_(or__35425__auto__)){
return or__35425__auto__;
} else {
...
var args132991 = [];
var len__36494__auto___132994 = arguments.length;
var i__36495__auto___132995 = (0);
while(true){
if((i__36495__auto___132995 < len__36494__auto___132994)){
args132991.push((arguments[i__36495__auto___132995]));

var G__132997 = (i__36495__auto___132995 + (1));
i__36495__auto___132995 = G__132997;
continue;
} else {
}
break;
...
var G__132993 = args132991.length;
switch (G__132993) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args132991.length)].join('')));
...
var args133007 = [];
var len__36494__auto___133010 = arguments.length;
var i__36495__auto___133011 = (0);
while(true){
if((i__36495__auto___133011 < len__36494__auto___133010)){
args133007.push((arguments[i__36495__auto___133011]));

var G__133012 = (i__36495__auto___133011 + (1));
i__36495__auto___133011 = G__133012;
continue;
} else {
}
break;
...
var G__133009 = args133007.length;
switch (G__133009) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args133007.length)].join('')));
...
var args133016 = [];
var len__36494__auto___133021 = arguments.length;
var i__36495__auto___133022 = (0);
while(true){
if((i__36495__auto___133022 < len__36494__auto___133021)){
args133016.push((arguments[i__36495__auto___133022]));

var G__133023 = (i__36495__auto___133022 + (1));
i__36495__auto___133022 = G__133023;
continue;
} else {
}
break;
...
var G__133019 = args133016.length;
switch (G__133019) {
case 1:
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args133016.length)].join('')));
...
var g = (function (){var or__35425__auto__ = new cljs.core.Keyword(null,"fn","fn",-1175266204).cljs$core$IFn$_invoke$arity$1(ns);
if(cljs.core.truth_(or__35425__auto__)){
return or__35425__auto__;
} else {
return f.name;
...
if(cljs.core.truth_((function (){var or__35425__auto__ = cljs.core.get_in.call(null,s,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"action","action",-811238024),new cljs.core.Keyword(null,"dont-record","dont-record",577283045)], null));
if(cljs.core.truth_(or__35425__auto__)){
return or__35425__auto__;
} else {
